...
bool isTokenInCollection(std::string const &token, std::string const &sentence) {
    return sentence.find(token) != std::string::npos;
}

bool isTokenInCollection(std::string const &token, std::vector<std::string> const &sentence) {
...
int main() {
    ...
    std::cout << "string,string " << isTokenInCollection(input, sentenceInput) << std::endl;
    std::cout << "string,string vector " << isTokenInCollection(input, tokens) << std::endl;
